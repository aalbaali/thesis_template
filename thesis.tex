...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Preface
%    Contribution to original knowledge. A doctoral thesis must clearly state
%    the elements of the thesis that are considered original scholarship and
...
% Make sure the bibliography entries are consistent and clean. JabRef is an
...
%   Appendices
\startappendices
% Change the chapter and section aliases for cleveref (i.e., when using \cref).
\crefalias{chapter}{appendix}
\crefalias{section}{appendix}

%-------------------------------------------------------------------------------
% Add the appendices chapters if needed.
% To stay consistent, put them in an external file (e.g., called appendices.tex) 
% and use \input{chapters/appendices.tex} to include them in the text.
